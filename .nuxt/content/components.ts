...
export const localComponentLoaders = {
  ...
  ServiceBlock: () => import("./../../app/components/service/block.vue").then(m => pickExport(m, "default", "ServiceBlock", "./../../app/components/service/block.vue")),
