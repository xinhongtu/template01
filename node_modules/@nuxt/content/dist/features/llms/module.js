...
export default defineNuxtModule({
  ...
  setup(_opts, nuxt) {
    ...
    const llmsOption = nuxt.options?.llms;
    ...
    nuxt.hook("modules:done", () => {
      const contentRawMarkdown = llmsOption?.contentRawMarkdown === false ? false : defu(llmsOption?.contentRawMarkdown, {
        excludeCollections: []
      });
      nuxt.options.llms ||= {};
